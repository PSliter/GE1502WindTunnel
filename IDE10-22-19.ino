...
void loop()
{
  ...
  lcd.print("Drag:");
  lcd.setCursor(7,0);
  lcd.print(fcr1cnst.substring(0,3));       //print hello, world! starting at that position

  lcd.setCursor(0,1);               //move the cursor to the first space of the bottom row
  lcd.print("Lift:");
  lcd.setCursor(7,1);
  lcd.print(fcr2cnst.substring(0,3));         //print the number of seconds that have passed since the last reset
